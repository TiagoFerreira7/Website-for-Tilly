...
import { fireworks,hellokitty } from '../assets';
    ...
    <div className="min-h-screen w-full bg-black/20 flex flex-col items-center justify-center">
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className='w-[90%] max-w-[400px]'>
          ...
          Estou muito feliz por estarmos juntos e por termos decidido continuar a nossa jornada lado a lado. Que a nossa relação siga sempre cheia de momentos bons e que possamos crescer juntos a cada dia.
          </p>

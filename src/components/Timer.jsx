...
function Timer() {
  // Anniversary date
  const START_DATE = new Date('2023-07-15')
  ...
  <div className="text-center z-10">
    ...
    <div className="flex items-center justify-center gap-3 sm:gap-4 text-5xl sm:text-7xl font-bold mb-6">
      <div className="flex flex-col items-center">
        ...
        <span className="text-sm sm:text-2xl mt-1 sm:mt-2">Dias</span>
      </div>
    ...
    <p className=' text-lg mb-8 drop-shadow-lg'>{`... e a contar <3` }</p>
    {/* Button */}
    <div className="flex justify-center w-full">
      ...
      >
        Ir para a próxima página <ArrowRight/>
      </button>
    </div>
  </div>
</div>

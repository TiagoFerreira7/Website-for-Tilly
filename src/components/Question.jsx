...
function Question() {
  ...
  const trends = ['Porque o meu namorado é tão giro?', 'Porque o Tiago ama-me mais?', `Aniversário do Tiago (para não te esqueceres)`,]

  const handleSearch = (e) => {
    e.preventDefault()
    if (searchQuery.toLowerCase() === 'há quanto tempo estamos juntos??' || searchQuery.toLowerCase() === 'há quanto tempo estamos juntos?') {
          navigate("/timer");
       ...
       <div
        ...
        >
          ...
          <div className="mt-8 w-full max-w-[600px]">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl">Pesquisas Populares</h2>
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p>Dica: Tenta pesquisar "há quanto tempo estamos juntos?" :3</p>
          </div>
        </div>
      )}
    </div>
